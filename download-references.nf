...
def helpMessage() {
    ...
    Options:
      ...
      --genome [str]                Genome version for human: GRCh37 or GRCh38 (default)
...
process download_base {
    ...
    wget \$BASEURL/release-${params.reference_release}/gtf/homo_sapiens/Homo_sapiens.${params.genome}.${params.reference_release}.chr.gtf.gz -O Homo_sapiens.${params.genome}_r${params.reference_release}.gtf.gz
...
process download_star_fusion {
    ...
    script:
    """
    aws s3 --no-sign-request --region ${params.awsregion} cp s3://ngi-igenomes/Homo_sapiens/Ensembl/${params.genome}/Genome/CTAT/ctat_star_fusion_1_8_1.tar.gz .
